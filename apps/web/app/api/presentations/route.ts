...
async function postPresentation(request: NextRequest) {
	...
	const generateObjectArgs = {
		...
		system: `You are in charge of initializing a new presentation based on the user prompt, you should generate a title for it and the update requests. By default, the first slide is going to be deleted, then, the update requests generated by you are going to be run.
${guidelines('creator')}`,
		prompt,
		schema: z.object({
